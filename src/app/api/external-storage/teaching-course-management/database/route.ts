...
export const GET = createExternalStorageTeachingCourseManagementDatabaseGetHandler();
export const PUT = createExternalStorageTeachingCourseManagementDatabasePutHandler();
