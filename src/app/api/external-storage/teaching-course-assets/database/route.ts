...
export const GET = createExternalStorageTeachingCourseAssetsDatabaseGetHandler();
export const PUT = createExternalStorageTeachingCourseAssetsDatabasePutHandler();
