...
function readStudentRosterSyncProviderConfig(
  env: Record<string, string | undefined>,
) {
...
function readKnowledgeIndexSyncProviderConfig(
  env: Record<string, string | undefined>,
) {
...
function readCollaborationInviteEmailProviderConfig(
  env: Record<string, string | undefined>,
) {
...
function readCourseContentPublishProviderConfig(
  env: Record<string, string | undefined>,
) {
...
function readCourseExportProviderConfig(env: Record<string, string | undefined>) {
...
function readGradingFeedbackProviderConfig(env: Record<string, string | undefined>) {
...
function readExternalTeachingProviderUrl(
  rawUrl: string,
...
function isDisallowedExternalTeachingProviderHost(hostname: string) {
...
function readProviderDeliveryId(value: unknown) {
...
function readProviderPublishId(value: unknown) {
...
function readProviderExportId(value: unknown) {
...
function readProviderFeedbackId(value: unknown) {
...
function readProviderSyncId(value: unknown) {
...
function readKnowledgeProviderSyncId(value: unknown) {
  if (!isRecord(value) || value.status !== "synced") {
    throw new TeachingCourseManagementStoreError(
      502,
