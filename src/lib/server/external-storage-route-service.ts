...
function createTeachingCourseManagementSnapshot(
  database: TeachingCourseManagementDatabase,
...
function createTeachingCourseManagementRevision(
  database: TeachingCourseManagementDatabase,
) {
  if (
...
function createEmptyTeachingCourseManagementDatabase(): TeachingCourseManagementDatabase {
  return {
    schemaVersion: "uais-teaching-course-management-v1",
...
function createTeachingCourseAssetsRevision(database: TeachingCourseAssetsDatabase) {
  if (
    database.updatedAt === "1970-01-01T00:00:00.000Z" &&
...
function createEmptyTeachingCourseAssetsDatabase(): TeachingCourseAssetsDatabase {
  return {
    schemaVersion: "uais-teaching-course-assets-v1",
    updatedAt: "1970-01-01T00:00:00.000Z",
    assets: [],
...
function createTeachingCourseManagementBackupReceipt(
  backup: ReturnType<typeof normalizeTeachingCourseManagementBackup>,
) {
  return {
    backupId: backup.backupId,
...
function createTeachingCourseAssetsBackupReceipt(
  backup: ReturnType<typeof normalizeTeachingCourseAssetsBackup>,
) {
  return {
    backupId: backup.backupId,
...
function normalizeOwnership(value: unknown): UaisTeacherAiResourceOwnership {
  if (!isRecord(value)) {
...
function normalizeLifecycleAuditEvent(value: unknown): QwenVoiceLifecycleAuditEvent {
  if (!isRecord(value)) {
...
function normalizeTeachingOperationRecord(value: unknown) {
  if (!isRecord(value)) {
...
function normalizeTeachingOperationDomainProjection(value: unknown) {
  if (!isRecord(value)) {
...
function normalizeTeachingOperationArtifact(value: unknown): Record<string, unknown> {
  if (!isRecord(value)) {
...
function normalizeArtifactValue(value: unknown): unknown {
...
function normalizeTeachingOperationAuditEvent(value: unknown) {
  if (!isRecord(value)) {
...
function normalizeTeachingOperationRollbackRequest(value: unknown) {
  if (!isRecord(value)) {
...
function normalizeTeachingOperationBackupRequest(value: unknown) {
  if (!isRecord(value)) {
...
function normalizeTeachingCourseManagementBackupRequest(value: unknown) {
  if (!isRecord(value)) {
    throw new HttpError(
      400,
...
function normalizeTeachingCourseManagementRestoreDrillRequest(value: unknown) {
  if (!isRecord(value)) {
    throw new HttpError(
      400,
...
function normalizeTeachingCourseAssetsBackupRequest(value: unknown) {
  if (!isRecord(value)) {
...
function normalizeTeachingCourseAssetsRestoreDrillRequest(value: unknown) {
  if (!isRecord(value)) {
    throw new HttpError(
      400,
...
function normalizeTeachingOperationRestoreDrillRequest(value: unknown) {
  if (!isRecord(value)) {
    throw new HttpError(
      400,
...
function normalizeTeachingOperationAuditLedgerEntry(
  value: unknown,
  teacherId: string,
) {
  if (!isRecord(value)) {
...
function normalizeTeachingOperationRollbackLedgerEntry(
  value: unknown,
  teacherId: string,
) {
  if (!isRecord(value)) {
...
function normalizeTeachingOperationRollbackRecord(value: unknown) {
  if (!isRecord(value)) {
...
function normalizeTeachingOperationBackup(value: unknown) {
  if (!isRecord(value)) {
...
function normalizeTeachingOperationBackupSnapshot(value: unknown) {
  if (!isRecord(value)) {
...
function normalizeTeachingOperationRecordCounts(value: unknown) {
  if (!isRecord(value)) {
...
function normalizeTeachingCourseManagementBackup(value: unknown) {
  if (!isRecord(value)) {
...
function normalizeTeachingCourseManagementBackupSnapshot(value: unknown) {
  if (!isRecord(value)) {
    throw new HttpError(
      400,
...
function normalizeTeachingCourseManagementRecordCounts(value: unknown) {
  if (!isRecord(value)) {
    throw new HttpError(
      400,
...
function normalizeTeachingCourseManagementRestoreDrill(value: unknown) {
  if (!isRecord(value)) {
    throw new HttpError(
      400,
...
function normalizeTeachingCourseAssetsBackup(value: unknown) {
  if (!isRecord(value)) {
...
function normalizeTeachingCourseAssetsBackupSnapshot(value: unknown) {
  if (!isRecord(value)) {
...
function normalizeTeachingCourseAssetsRecordCounts(value: unknown) {
  if (!isRecord(value)) {
...
function normalizeTeachingCourseAssetsRestoreDrill(value: unknown) {
  if (!isRecord(value)) {
...
function normalizeTeachingOperationRestoreDrill(value: unknown) {
  if (!isRecord(value)) {
...
function normalizeAlertNotificationRequest(value: unknown) {
  if (!isRecord(value)) {
...
function normalizeTeachingOperationAlertNotification(
  value: unknown,
...
function normalizeTeachingOperationAlertWebhookDelivery(value: unknown) {
  if (!isRecord(value)) {
    throw new HttpError(
      400,
