...
const fallbackCourseId = "research-methods-learning";
const publishedLearningPptCourseId = "elementary-math-research";

const playbackByCourseId: Record<string, Record<Locale, PlaybackContent>> = {
...
function getPlaybackContent(courseId: string, locale: Locale) {
  return (
...
function getFallbackCourseTitle(playback: PlaybackContent, locale: Locale) {
...
function createSlideStudyContent({
  locale,
  playback,
  publishedPlayback,
...
function createAskThisSlidePrompt(content: SlideStudyContent, locale: Locale) {
  return locale === "zh-CN"
...
function createStudyNotesMarkdown(content: SlideStudyContent, locale: Locale) {
  if (locale === "zh-CN") {
    return [
      `# ${content.slideTitle}`,
      "",
...
function createSafeDownloadFileName(title: string) {
...
function exportSlideStudyNotes(content: SlideStudyContent, locale: Locale) {
...
const courseDirectoryLessonTimes = ["08:15", "15:30", "09:40", "11:55", "05:00"] as const;

const courseDirectoryChapters = [
  {
    title: {
      "zh-CN": "第一章 数系",
      "en-US": "Chapter 1 Number Systems",
    },
    time: "45:20",
    lessons: [
      {
        title: {
          "zh-CN": "1.1 数的概念的扩展",
          "en-US": "1.1 Extending the Concept of Number",
        },
      },
      {
        title: {
          "zh-CN": "1.2 自然数集",
          "en-US": "1.2 Set of Natural Numbers",
        },
      },
      {
        title: {
          "zh-CN": "1.3 整数环",
          "en-US": "1.3 Ring of Integers",
        },
      },
      {
        title: {
          "zh-CN": "1.4 有理数域",
          "en-US": "1.4 Field of Rational Numbers",
        },
      },
      {
        title: {
          "zh-CN": "1.5 实数域",
          "en-US": "1.5 Field of Real Numbers",
        },
      },
      {
        title: {
          "zh-CN": "1.6 复数域",
          "en-US": "1.6 Field of Complex Numbers",
        },
      },
    ],
  },
  {
    title: {
      "zh-CN": "第二章 解析式",
      "en-US": "Chapter 2 Analytic Expressions",
    },
    time: "52:10",
    lessons: [
      {
        title: {
          "zh-CN": "2.1 解析式概念及其分类",
          "en-US": "2.1 Concept and Classification of Analytic Expressions",
        },
      },
      {
        title: {
          "zh-CN": "2.2 多项式",
          "en-US": "2.2 Polynomials",
        },
      },
      {
        title: {
          "zh-CN": "2.3 分式",
          "en-US": "2.3 Rational Expressions",
        },
      },
    ],
  },
  {
    title: {
      "zh-CN": "第三章 初等函数",
      "en-US": "Chapter 3 Elementary Functions",
    },
    time: "48:30",
    lessons: [
      {
        title: {
          "zh-CN": "3.1 函数概念",
          "en-US": "3.1 Function Concept",
        },
      },
      {
        title: {
          "zh-CN": "3.2 用初等方法讨论函数",
          "en-US": "3.2 Discussing Functions with Elementary Methods",
        },
      },
    ],
  },
    ...
    lessons: [
      {
        title: {
          "zh-CN": "4.1 方程与方程的同解性",
          "en-US": "4.1 Equations and Equivalent Equations",
        },
      },
      {
        title: {
          "zh-CN": "4.2 几种特殊类型的代数方程的解法",
          "en-US": "4.2 Solving Special Types of Algebraic Equations",
        },
      },
    ],
  },
    ...
    lessons: [
      {
        title: {
          "zh-CN": "5.1 不等式及其性质",
          "en-US": "5.1 Inequalities and Their Properties",
        },
      },
      {
        title: {
          "zh-CN": "5.2 证明不等式的常用方法",
          "en-US": "5.2 Common Methods for Proving Inequalities",
        },
      },
      {
        title: {
          "zh-CN": "5.3 几个著名的不等式",
          "en-US": "5.3 Several Famous Inequalities",
        },
      },
    ],
  },
    ...
    lessons: [
      {
        title: {
          "zh-CN": "6.1 勾股定理的推广",
          "en-US": "6.1 Extensions of the Pythagorean Theorem",
        },
      },
      {
        title: {
          "zh-CN": "6.2 直线与平面",
          "en-US": "6.2 Lines and Planes",
        },
      },
    ],
  },
